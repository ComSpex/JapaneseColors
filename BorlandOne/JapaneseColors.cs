...
namespace BorlandOne {
	public class JapaneseColors {
		...
		public IEnumerable<KeyValuePair<string,NamedSolidColorBrush>> Cores {
			get {
				...
				foreach(FieldInfo prop in props) {
					...
					yield return new KeyValuePair<string,NamedSolidColorBrush>(prop.Name,nscb);
				}
			}
		}
		/// <summary>
		...
		public static NamedSolidColorBrush 中紅 = new NamedSolidColorBrush(200,081,121,"なかべに");
		public static NamedSolidColorBrush 桜色 = new NamedSolidColorBrush(253,221,218,"さくらいろ");
		public static NamedSolidColorBrush 退紅 = new NamedSolidColorBrush(208,114,122,"あらぞめ");
		public static NamedSolidColorBrush 薄紅 = new NamedSolidColorBrush(248,165,173,"うすべに");
		public static NamedSolidColorBrush 鴇色 = new NamedSolidColorBrush(251,194,188,"ときいろ");
		...
		public static NamedSolidColorBrush 甚三紅 = new NamedSolidColorBrush(238,130,124,"じんざもみ");// http://dictionary.goo.ne.jp/leaf/jn2/114253/m0u/
		public static NamedSolidColorBrush 水柿 = new NamedSolidColorBrush(228,171,155,"みずがき");
		public static NamedSolidColorBrush 梅鼠 = new NamedSolidColorBrush(173,121,132,"うめねずみ");
		public static NamedSolidColorBrush 蘇芳香 = new NamedSolidColorBrush(168,105,101,"すおうこう");
		public static NamedSolidColorBrush 赤紅 = new NamedSolidColorBrush(197,061,067,"あかべに");
		public static NamedSolidColorBrush 真朱 = new NamedSolidColorBrush(236,109,113,"しんしゅ,まおそ");
		public static NamedSolidColorBrush 小豆色 = new NamedSolidColorBrush(160,073,064,"あずきいろ");
		public static NamedSolidColorBrush 銀朱 = new NamedSolidColorBrush(200,085,084,"ぎんしゅ");
		public static NamedSolidColorBrush 海老茶 = new NamedSolidColorBrush(141,041,030,"えびちゃ");
		public static NamedSolidColorBrush 栗梅 = new NamedSolidColorBrush(108,025,018,"くりうめ");
		public static NamedSolidColorBrush 曙色 = new NamedSolidColorBrush(249,163,131,"あけぼのいろ");
		...
		public static NamedSolidColorBrush 芝翫茶 = new NamedSolidColorBrush(185,108,000,"しかんちゃ"); // http://www.shikanko.co.jp/shikanko/
		public static NamedSolidColorBrush 柿渋色 = new NamedSolidColorBrush(189,120,098,"かきしぶいろ");
		public static NamedSolidColorBrush 団十郎茶 = new NamedSolidColorBrush(189,120,098,"だんじゅうろうちゃ",true);
		...
		public static NamedSolidColorBrush 緋 = new NamedSolidColorBrush(186,038,054,"あけ");
		public static NamedSolidColorBrush 紅柄色 = new NamedSolidColorBrush(170,086,046,"べんがらいろ");
		public static NamedSolidColorBrush 檜皮色 = new NamedSolidColorBrush(107,066,036,"ひはだいろ");
		public static NamedSolidColorBrush 宍色 = new NamedSolidColorBrush(239,171,147,"ししいろ");
		public static NamedSolidColorBrush 赤香色 = new NamedSolidColorBrush(246,184,148,"あかこういろ");
		public static NamedSolidColorBrush 黄丹 = new NamedSolidColorBrush(247,130,037,"おうたん");//皇太子色
		public static NamedSolidColorBrush 纁 = new NamedSolidColorBrush(251,160,039,"そひ");
		public static NamedSolidColorBrush 蘇比 = new NamedSolidColorBrush(251,160,039,"そひ",true);
		public static NamedSolidColorBrush 遠州茶 = new NamedSolidColorBrush(202,130,105,"えんしゅうちゃ");
		public static NamedSolidColorBrush 唐茶 = new NamedSolidColorBrush(160,103,005,"からちゃ");
		public static NamedSolidColorBrush 樺茶 = new NamedSolidColorBrush(114,098,080,"かばちゃ");
		public static NamedSolidColorBrush 雀茶 = new NamedSolidColorBrush(152,046,033,"すずめちゃ");
		public static NamedSolidColorBrush 栗皮茶 = new NamedSolidColorBrush(130,069,034,"くりかわちゃ");
		public static NamedSolidColorBrush 百塩茶 = new NamedSolidColorBrush(084,045,036,"ももしおちゃ");
		public static NamedSolidColorBrush 鳶色 = new NamedSolidColorBrush(122,056,015,"とびいろ");
		public static NamedSolidColorBrush 胡桃染 = new NamedSolidColorBrush(160,100,112,"くるみぞめ");
		public static NamedSolidColorBrush 樺色 = new NamedSolidColorBrush(197,089,026,"かばいろ");
		public static NamedSolidColorBrush 黄櫨染 = new NamedSolidColorBrush(215,075,034,"こうろぜん");//天皇色
		public static NamedSolidColorBrush 焦茶 = new NamedSolidColorBrush(106,077,050,"こげちゃ");
		public static NamedSolidColorBrush 深支子 = new NamedSolidColorBrush(239,187,044,"こきくちなし");
		public static NamedSolidColorBrush 洗柿 = new NamedSolidColorBrush(240,182,148,"あらいがき");
		public static NamedSolidColorBrush 代赭色 = new NamedSolidColorBrush(179,108,060,"たいしゃいろ");
		public static NamedSolidColorBrush 赤白橡 = new NamedSolidColorBrush(254,210,174,"あかしろつるばみ");
		public static NamedSolidColorBrush 礪茶 = new NamedSolidColorBrush(159,111,085,"とのちゃ");
		public static NamedSolidColorBrush 洒落柿 = new NamedSolidColorBrush(247,189,143,"しゃれがき");
		public static NamedSolidColorBrush 薄柿 = new NamedSolidColorBrush(212,172,173,"うすがき");
		public static NamedSolidColorBrush 萱草色 = new NamedSolidColorBrush(253,169,000,"かんぞういろ");
		public static NamedSolidColorBrush 梅染 = new NamedSolidColorBrush(180,138,118,"うめぞめ");
		public static NamedSolidColorBrush 紅鬱金 = new NamedSolidColorBrush(203,131,071,"べにうこん");
		public static NamedSolidColorBrush 憲法染 = new NamedSolidColorBrush(087,071,056,"けんぽうぞめ");
		public static NamedSolidColorBrush 枇杷茶 = new NamedSolidColorBrush(174,124,079,"びわちゃ");
		public static NamedSolidColorBrush 琥珀色 = new NamedSolidColorBrush(234,147,010,"こはくいろ");
		public static NamedSolidColorBrush 淡香 = new NamedSolidColorBrush(243,191,136,"うすこう");
		public static NamedSolidColorBrush 朽葉 = new NamedSolidColorBrush(145,115,071,"くちば");
		public static NamedSolidColorBrush 金茶 = new NamedSolidColorBrush(206,122,025,"きんちゃ");
		public static NamedSolidColorBrush 丁子染 = new NamedSolidColorBrush(221,184,126,"ちょうじぞめ");
		public static NamedSolidColorBrush 狐色 = new NamedSolidColorBrush(217,151,047,"きつねいろ");
		public static NamedSolidColorBrush 伽羅色 = new NamedSolidColorBrush(216,163,115,"きゃらいろ");
		public static NamedSolidColorBrush 煤竹 = new NamedSolidColorBrush(091,049,035,"すすたけ");
		public static NamedSolidColorBrush 白茶 = new NamedSolidColorBrush(218,196,165,"しらちゃ");
		public static NamedSolidColorBrush 黄土色 = new NamedSolidColorBrush(195,145,067,"おうどいろ");
		public static NamedSolidColorBrush 黄唐茶 = new NamedSolidColorBrush(185,140,070,"きからちゃ");
		public static NamedSolidColorBrush 浅黄 = new NamedSolidColorBrush(237,211,161,"うすき");
		public static NamedSolidColorBrush 山吹色 = new NamedSolidColorBrush(255,197,037,"やまぶきいろ");
		...
		public static NamedSolidColorBrush 山吹茶 = new NamedSolidColorBrush(200,153,050,"やまぶきちゃ");
		public static NamedSolidColorBrush 桑染 = new NamedSolidColorBrush(218,188,145,"くわぞめ");
		public static NamedSolidColorBrush 生壁色 = new NamedSolidColorBrush(170,140,099,"なまかべいろ");
		public static NamedSolidColorBrush 支子 = new NamedSolidColorBrush(255,216,120,"くちなし");
		public static NamedSolidColorBrush 玉蜀黍色 = new NamedSolidColorBrush(238,195,098,"とうもろこしいろ");
		public static NamedSolidColorBrush 白橡 = new NamedSolidColorBrush(203,185,148,"しろつるばみ");
		public static NamedSolidColorBrush 黄橡 = new NamedSolidColorBrush(162,112,051,"きつるばみ");
		public static NamedSolidColorBrush 藤黄 = new NamedSolidColorBrush(247,193,020,"とうおう");
		public static NamedSolidColorBrush 花葉色 = new NamedSolidColorBrush(251,210,107,"はなばいろ");
		public static NamedSolidColorBrush 鳥の子色 = new NamedSolidColorBrush(255,232,217,"とりのこいろ");
		public static NamedSolidColorBrush 鬱金色 = new NamedSolidColorBrush(247,194,041,"うこんいろ");
		...
		public static NamedSolidColorBrush 肥後煤竹 = new NamedSolidColorBrush(137,120,088,"ひごすすたけ");
		public static NamedSolidColorBrush 路考茶 = new NamedSolidColorBrush(171,131,054,"ろこうちゃ");
		public static NamedSolidColorBrush 海松茶 = new NamedSolidColorBrush(087,084,061,"みるちゃ");
		...
		public static NamedSolidColorBrush 黄檗 = new NamedSolidColorBrush(252,226,063,"きはだ");
		...
		public static NamedSolidColorBrush 青白橡 = new NamedSolidColorBrush(133,145,109,"あおしろつるばみ");
		...
		public static NamedSolidColorBrush 沈香茶 = new NamedSolidColorBrush(067,103,082,"とのちゃ");
		...
		public static NamedSolidColorBrush 褐色 = new NamedSolidColorBrush(000,056,071,"かちいろ");
		public static NamedSolidColorBrush 瑠璃色 = new NamedSolidColorBrush(000,091,160,"るりいろ");
